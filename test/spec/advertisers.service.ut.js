            ...
            describe('methods', function() {
                ...
                describe('putAdvertiser(id, advertiser)', function() {
                    ...
                    beforeEach(function(){
                        ...
                        editedAdvertiser = {};
                        ['name','defaultLinks','defaultLogos','status'].forEach(function(prop) {
                            editedAdvertiser[prop] = mockAdvertiser[prop];
                        });
                    });
                ...
                describe('postAdvertiser(advertiser)', function() {
                    ...
                    beforeEach(function(){
                        ...
                        newAdvertiser = {};
                        ['name','defaultLinks','defaultLogos','status'].forEach(function(prop) {
                            newAdvertiser[prop] = mockAdvertiser[prop];
                        });
                    });
